<%@ WebHandler Language="C#" Class="RespostasHandler" %>

using System;
using System.Web;

// Estação 03 — "E se fosse com você?"
public class RespostasHandler : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            var texto = Helpers.CleanText(Helpers.GetString(data, "texto"), 500);
            if (string.IsNullOrEmpty(texto))
            {
                Helpers.WriteJson(context, 400, new { erro = "Escreva sua resposta antes de enviar." });
                return;
            }
            Store.InsertResposta(texto);
